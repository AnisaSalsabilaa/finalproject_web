...
<div class="container">
	<div class="row profile">
		...
		<div class="col">
			<div class="content">
				<h1><b>Daftar Layanan</b></h1>
				<hr>
				<table width="130%" border="0" cellpadding="2" cellspacing="1">

					<tbody>
						<tr>
							<td colspan="2"><a href="tambah_layanan.php" target="_self"><img src="add.png">Tambah Layanan</a></td>
							<td colspan="2"><a href="import_excel.php?bagian=layanan" target="_self"><img src="add.png"> Laporan Excel</a></td> 
						</tr>
										...
										?>
											<tr>
												...
												<td style="align-items: center">
													<a href="edit_layanan.php?id=<?php echo $r['ID_LAYANAN']; ?>"><img src="edit.png"> </a>
													<a href="hapus_layanan.php?id=<?php echo $r['ID_LAYANAN']; ?>" onclick="return confirm('Yakin Hapus?')"><img src="delete.png"> </a>
												</td>
											</tr>
											<?php $i = $i + 1; ?>
										<?php } ?>
